web: voila --port=$PORT --no-browser --template=material --enable_nbextensions=True California.ipynb
alabaster==0.7.12
...
param @ file:///tmp/build/80754af9/param_1610132696605/work
parso==0.7.0
partd==1.1.0
...
pyct @ file:///opt/concourse/worker/volumes/live/19d9e9a3-09e8-4817-4195-a8fbe79130ec/volume/pyct_1600458313544/work
pycurl==7.43.0.6
...
-e git+https://github.com/twitterdev/search-tweets-python@9656a8e3806ed02ef8a30631233d2a7a9fb2f7b9#egg=searchtweets
Send2Trash==1.5.0
simplegeneric==0.8.1
